  ...
  try {
    ...
    const client = new GoogleGenAI( {apiKey: process.env.GEMINI_API_KEY})
      ...
      const response = await client.models.generateContent({
        ...
        contents:`You are a learning assistant for developers. Analyze the following web page content and return ONLY a raw JSON object with no markdown formatting, no code blocks, no backticks. Use double quotes for all keys and values. Use this exact structure:
